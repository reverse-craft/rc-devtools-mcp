...
import type {ConsoleMessageType} from '../third-party/index.js';
...
/**
 * Tool to list all console messages for the currently selected page.
 */
export const listConsoleMessages = defineTool({
  ...
  schema: {
    ...
    savePath: zod
      ...
      .optional()
      .describe(
        'File path to save console messages. When provided, messages are saved to this file.',
      ),
    maxLineLength: zod
      .number()
      .int()
      ...
      .optional()
      .describe(
        'Maximum length of each console message line. Messages exceeding this length will be truncated. Default is 500.',
      ),
  },
  handler: async (request, response) => {
    response.setIncludeConsoleData(true, {
      ...
      savePath: request.params.savePath,
      maxLineLength: request.params.maxLineLength,
    });
  },
});

/**
 * Tool to get a specific console message by its ID.
 */
