...
import type {Page, Protocol, CdpPage} from '../third-party/index.js';

/**
 * Helper class for waiting on page events and DOM stability.
 * Handles navigation and DOM mutation observation.
 */
